package com.localcoin.batm.extensions.extra.bitcoin;
...
public class LCBitGoExtensionTest {
    ...
    private static final Logger log = LoggerFactory.getLogger(LCBitGoExtensionTest.class);
    ...
    private void testUrl(String expected, String walletLogin) {
        final LCBitGoExtension LCBitGoExtension = new LCBitGoExtension();
        LCBitGoExtension.init(new TestExtensionContext());
        final IWallet bitgowallet = LCBitGoExtension.createWallet(walletLogin, null);
    ...
    private void doTestCreateWalletBitGoFees(String url, Integer expectedFeeRate, Integer expectedMaxFeeRate) {
        final LCBitGoExtension LCBitGoExtension = new LCBitGoExtension();
        LCBitGoExtension.init(new TestExtensionContext());
        final IWallet wallet = LCBitGoExtension.createWallet(url, null);
    ...
    public void bitgoFullTokenTest() {
        ...
        final LCBitGoExtension LCBitGoExtension = new LCBitGoExtension();
        LCBitGoExtension.init(new TestExtensionContext());
        final IWallet bitgowallet = LCBitGoExtension.createWallet(wallet, null);
        Assert.assertTrue(bitgowallet instanceof BitgoWallet);
    ...
    public void bitgoWalletTest() {
        ...
        final LCBitGoExtension LCBitGoExtension = new LCBitGoExtension();
        LCBitGoExtension.init(new TestExtensionContext());
        final IWallet wallet = LCBitGoExtension.createWallet(address, null);
        Assert.assertTrue(wallet instanceof BitgoWallet);
        final BitgoWallet bitgoWallet = (BitgoWallet)wallet;
        Assert.assertNotNull(bitgoWallet);
        Assert.assertNotNull(bitgoWallet);
